...
To properly identify what we needed to build we used abstraction laddering techniques. We started with a very abstract "Goal" of the product and moved further into a concrete solution by breaking down capabilites of stakeholders. From those capabilites, we could start identifying features to be built.
